...
def batch_train_sequence_model(data,
    ...
    ''' '''
    embedding_matrix = train_fine_tuned_sequence_model._get_embedding_matrix(word_index, FLAGS.embedding_data_dir, embedding_dim)
    ''' '''
    ...
    # Get number of training steps. This indicates the number of steps it takes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='../../RNN/',
                        help='input data directory')
    parser.add_argument('--embedding_data_dir', type=str, default='../glove.6B',
